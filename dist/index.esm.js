...
const Badge = ({ label = 0, type = 'primary', className, max = 11 }) => {
...
const Input = (props) => {
    const { className, placeholder, autoFocus = false, disabled = false, type, adornment, required, onChange, ornament, error = false } = props, rest = __rest(props, ["className", "placeholder", "autoFocus", "disabled", "type", "adornment", "required", "onChange", "ornament", "error"]);
...
const Menu = ({ style, menuData, bg, color, onClick }) => {
    ...
    return (React__default.createElement(BrowserRouter, null,
        React__default.createElement("div", { className: "menuContainer", style: menuStyles }, menuData === null || menuData === void 0 ? void 0 : menuData.map((menuItem, index) => {
            var _a;
...
const Select = (_a) => {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("div", Object.assign({}, props, { className: `selectContainer select ${className || ''}`, style: containerStyle, onClick: handleSelectOpen, ref: selectRef }),
        ...
        openSelect && option && (React__default.createElement("div", { className: `selectItems select ${className || ''}`, style: optionStyle }, option.map((selectData) => {
