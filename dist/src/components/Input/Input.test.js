...
describe('Input Component', () => {
    test('should render an input field with the provided props', () => {
        ...
        const { getByTestId } = render(React.createElement(Input, { type: "text", placeholder: "Enter your name", required: true, onChange: onChangeMock, "data-testid": "input" }));
    ...
    test('should toggle password visibility when clicking the password visibility button', () => {
        const { getByTestId } = render(React.createElement(Input, { type: "password", placeholder: "Enter your password", "data-testid": "passwordInput" }));
    ...
    test('should render an input field with adornment', () => {
        const { getByTestId } = render(React.createElement(Input, { type: "text", placeholder: "Enter your email", adornment: "@domain.com", "data-testid": "adornmentInput" }));
    ...
    test('should render an input field with ornament', () => {
        const { getByTestId } = render(React.createElement(Input, { type: "text", placeholder: "Enter your name", ornament: "*", "data-testid": "oranmentInput" }));
