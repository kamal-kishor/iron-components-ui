...
const Button = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        type === 'button' && (React.createElement("button", { ...props, type: "button", className: `${className ? className : `button button-${variant}`} ${disabled ? `button_disabled` : ''} ${startIcon ? 'Icon' : ''} ${endIcon ? 'Icon' : ''}`, onClick: onClick, disabled: disabled },
...
const Input = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        type === 'password' && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} commonInputDiv combinedInputField ${className ? className : ''}` },
        ...
        type !== 'password' && !adornment && !ornament && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} ${className ? className : ''} commonInputDiv` },
        ...
        type !== 'password' && adornment && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: `${error ? 'error' : ''} combinedInputField ${className ? className : ''}` },
